...
- **Phase 0.5 is complete** — see [ithkuil-validation-report.md](ithkuil-validation-report.md). Verdict: the font is faithful to the 2011 script wherever a reference exists (primary 24/24, tertiary 7/7, 11 consonants); only 2 genuine glyph discrepancies (`k'`, `y`); ~55 glyphs have no isolated reference (diacritics, numerals, font-only secondaries) and are *not* errors. The 2011-vs-New-Ithkuil direction call gates Phase 1.
